...
describe('R1-manager-last-name-not-provided', function() {
  this.timeout(30000);
  let driver;
  let vars;
  ...
  it('R1-manager-last-name-not-provided', async function() {
    ...
    await driver
      .findElement(By.css('.v-input--is-focused .v-input__slot'))
      .click();
    {
    ...
    await driver
      .findElement(By.id('compnay-email'))
      .sendKeys('mercadolibre@gmail.com');
    await driver.findElement(By.id('company-phone-number')).click();
    await driver
      .findElement(By.id('company-phone-number'))
      .sendKeys('+1 (212) 565-6565');
    ...
    await driver.findElement(By.id('commercial-ally-description')).click();
    {
      const element = await driver.findElement(
        By.css('.blue--text > .v-btn__content'),
      );
    }
    await driver
      .findElement(By.id('commercial-ally-description'))
      .sendKeys('Ecommerce');
