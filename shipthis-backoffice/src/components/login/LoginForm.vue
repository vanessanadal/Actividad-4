        ...
        <v-card-text class="text-center">
          <v-form>
            ...
            <v-text-field
              ...
              v-model="user_email" id="login-email"
              :rules="[rules.required]"
            ></v-text-field>
            <v-text-field
              label="Password" class="mb-7" id="login-password"
          ...
          <v-card class="password-card">
              <v-card-text class="text-center">
                <v-form>
                    ...
                    <v-text-field
                    label="Email" class="mb-7 mt-4" id="login-email"
                    prepend-inner-icon="email"
                    solo style="max-height: 50px;"
                    v-model="user_email"
                    :rules="[rules.required]"
                    ></v-text-field>
                    <v-text-field
                    label="ID Document " class="mb-7" id="login-document"
