...
describe('throws an error when no manager last name is provided', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('throws an error when no manager last name is provided', async function() {
    ...
    await driver.findElement(By.id("company-phone-number")).sendKeys("+1 (212) 565-9594")
